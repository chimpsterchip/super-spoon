...
GLuint ShaderLoader::CreateProgram(char* VertexShaderFilename, char* GeometryShaderFilename,
	char* FragmentShaderFilename)
{
...
GLuint ShaderLoader::CreateProgram(char* VertexShaderFilename, char* TessControlShaderFilename,
	...
	char* FragmentShaderFilename)
{
	...
	GLuint tessEval_shader = CreateShader(GL_TESS_EVALUATION_SHADER, tessEval_shader_code, "tessEval shader");
	GLuint fragment_shader = CreateShader(GL_FRAGMENT_SHADER, fragment_shader_code, "fragment shader");
